...
import { FaSlack, FaFigma, FaGithub, FaJira } from "react-icons/fa";
        ...
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${scrolled ? "bg-white/95 backdrop-blur-xl border-b border-slate-200" : "bg-transparent"}`}>
            <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-3">
                    <button className="px-4 py-2 rounded-lg text-sm font-semibold cursor-pointer text-slate-600 transition-colors duration-150 hover:bg-slate-100"
                        onClick={()=> navigate('/login')}>
                        Connexion
                    </button>
                    <button className="px-4 py-2 rounded-full text-sm font-bold cursor-pointer text-white bg-indigo-600 transition-all duration-150 hover:opacity-90"
            ...
            {open && (
                <div className="md:hidden px-6 py-4 flex flex-col gap-1 bg-white border-t border-slate-200">
                    ...
                    <button className="mt-3 w-full py-2.5 rounded-full text-sm font-bold text-white bg-indigo-600 " onClick={()=> navigate('/register')}>
                        Inscription
                    </button>
                    <button className="mt-3 w-full py-2.5 rounded-full text-sm font-bold text-black bg-slate-200" onClick={()=> navigate('/login')}>
                        Connexion
                    </button>
                </div>
            )}
    ...
    return (
        <section className="relative pt-28 pb-16 overflow-hidden bg-gradient-to-b from-indigo-50 to-slate-50">
            ...
            <div className="relative max-w-7xl mx-auto px-6">
                ...
                >
                    <button className="flex items-center justify-center cursor-pointer gap-2 px-6 py-3 rounded-full text-sm font-bold text-white bg-indigo-600 shadow-[0_4px_14px_rgba(79,70,229,0.35)] transition-all duration-150 hover:opacity-90"
                        onClick={()=> navigate('/register')}>
            ...
            <div className="max-w-4xl mx-auto rounded-3xl p-12 text-center relative overflow-hidden bg-indigo-600">
                ...
                <div className="relative">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <button className="flex items-center justify-center cursor-pointer gap-2 px-6 py-3 rounded-full text-sm font-bold text-indigo-600 bg-white transition-all duration-150 hover:opacity-90"
                            onClick={()=> navigate('/register')}>
