            ...
            <div className="w-[85%] h-[90%] flex items-center justify-center gap-2">
                <div className="w-[50%] h-full flex flex-col items-center">
                    <div className="pt-10 mb-5">
                        <h2 className="text-2xl font-bold text-center my-4">Inscription</h2>
                    ...
                    <form className="flex flex-col w-md">
                        <div className="mb-2 w-full">
                            <input type="text" placeholder="Nom" className="px-2 p-2 border w-full border-gray-200 rounded-xl" />
                        </div>
                        ...
                        <button className="bg-black cursor-pointer hover:opacity-90 text-white rounded-xl p-2 px-2 mt-5">S'inscrire</button>
                    </form>

                    <p className="mt-5">Vous avez deja un compte? <span className="hover:underline cursor-pointer">Se connecter</span></p>
                </div>
                <div className="w-[50%] h-full bg-sky-100 rounded-xl flex flex-col items-center">
                    <img src={registerImg} alt="illustration" className='h-full'/>
                    <h2></h2>
                </div>
            </div>
        </section>
